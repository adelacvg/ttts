...
class DiffusionTts(nn.Module):
    ...
    def timestep_independent(self, aligned_conditioning, conditioning_latent, expected_seq_len, return_code_pred):
        ...
        # conditioning_latent = self.proj(conditioning_latent)
    ...
    def forward(self, x, hint, timesteps=None, context=None, control=None, precomputed_aligned_embeddings=None, conditioning_free=False, return_code_pred=False,only_mid_control=False, **kwargs):
    # def forward(self, x, timesteps, aligned_conditioning=None, conditioning_latent=None, precomputed_aligned_embeddings=None, conditioning_free=False, return_code_pred=False):
        ...
        """
        aligned_conditioning = hint
        conditioning_latent = context
